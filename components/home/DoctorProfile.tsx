...
export default function DoctorProfile() {
  return (
    <section className="py-16 bg-[#0a0c12] overflow-hidden relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            <div className="inline-block px-4 py-1.5 bg-primary/10 border border-primary/20 rounded-full mb-6">
              <span className="text-primary text-xs uppercase tracking-[0.3em] font-bold">Clinical Leadership</span>
            </div>

            <h2 className="text-3xl sm:text-4xl font-black text-white mb-8 font-outfit uppercase leading-tight tracking-tight">
              Prof. Dr. S.I. Joephin Soundar, <span className="text-primary tracking-normal">MDS</span>
            </h2>

            <div className="space-y-6 text-gray-400 leading-relaxed text-lg font-outfit text-justify">
            ...
            <div className="mt-12 grid grid-cols-2 gap-4">
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl hover:border-primary/40 transition-colors">
                ...
                <p className="text-gray-500 text-xs uppercase tracking-wider font-bold">Years Experience</p>
              </div>
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl hover:border-primary/40 transition-colors">
                <p className="text-primary font-bold text-xl mb-1">MDS</p>
                <p className="text-gray-500 text-xs uppercase tracking-wider font-bold">Post Graduation</p>
              </div>
            </div>
          </motion.div>
        </div>
